...
// grew from 800 to 4096 sectors to fit a larger kernel image (see link.ld's
// ASSERT) -- this region always starts right after the boot-time
// kernel-load budget, so it moves in lockstep with that constant. See
// README.md's "Orçamento de boot" section for the general procedure.
...
#define FS_END_LBA       6176u   // end of the filesystem's data region
